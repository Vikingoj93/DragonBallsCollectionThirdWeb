...
const DragonBallsSection = () => {
  ...
  return (
    <section className="flex flex-col justify-center items-center bg-gray-100 p-4 border-t border-white">
      ...
      <Link className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded hover:bg-blue-700 hover:scale-110 hover:bg-opacity-50" href="/dragonBalls">
        Más
      </Link>
    </section>
  );
