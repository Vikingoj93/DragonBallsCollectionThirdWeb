...
const TokenDescription = () => {
  ...
  const whitePaperData = [
    ...
    {
      title: '',
      description: `Quema de token, cada transacción de compra quemara un porcentaje del suministro total.`,
    },
    {
      title: '',
      description: `Aumento de valor, cada transacción de compra aumenta un porcentaje establecido del precio inicial.`,
    },
    {
      title: '',
